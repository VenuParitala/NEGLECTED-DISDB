...
t<-read.csv("DISEASE.csv")
u<-read.csv("control.csv")
v<-read.csv("select.csv")
aa<-read.csv("buruli ulcer.csv")
bb<-read.csv("chagas.csv")
cc<-read.csv("dengue.csv")
dd<-read.csv("dracunculiasis disease.csv")
ee<-read.csv("echinococcosis disease.csv")
ff<-read.csv("fascilolisis.csv")
gg<-read.csv("foodbrone.csv")
hh<-read.csv("human african trypanosomiasis.csv")
ii<-read.csv("leishmaniasies.csv")
jj<-read.csv("leprosy.csv")
kk<-read.csv("lymphatic filariasis.csv")
ll<-read.csv("mycetoma.csv")
mm<-read.csv("onchocerciasis.csv")
nn<-read.csv("rabies.csv")
oo<-read.csv("schistosomiasis.csv")
pp<-read.csv("soil transmitted helminthises.csv")
qq<-read.csv("trachoma.csv")
rr<-read.csv("yaws.csv")
ss<-read.csv("(taeniasis and neurocysticercosis).csv")
